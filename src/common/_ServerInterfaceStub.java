...
public class _ServerInterfaceStub extends org.omg.CORBA.portable.ObjectImpl implements common.ServerInterface
{
  ...
  public String changeReservation (String bookingId, common.CampusID newCampusName, short newRoomNo, common.Timeslot newTimeSlot)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                return changeReservation (bookingId, newCampusName, newRoomNo, newTimeSlot        );
            } finally {
                _releaseReply ($in);
            }
  } // changeReservation
